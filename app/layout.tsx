...
export const metadata: Metadata = {
  title: "CloudTech | Design & Development Studio",
  description: "Grow your business with CloudTech, a design & development studio that specializes in web design, SEO, and cloud services.",
